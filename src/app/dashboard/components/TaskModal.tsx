...
const TaskModal = ({ isOpen, onClose, statusCol, setTaskList }: any) => {

    // const statusChosed = statusCol ? statusCol : 'To Do'
    const [title, setTitle] = useState('');
    const [description, setDescription] = useState('');
    const [status, setStatus] = useState(statusCol);
    const [priority, setPriority] = useState('Low');
    const [deadline, setDeadline] = useState('');

    useEffect(() => {
        setStatus(statusCol || 'To Do');
    }, [statusCol]);
